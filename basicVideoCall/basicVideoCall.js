...
$("#vmute").click(function (e) {
  vmute();
})

$("#vunmute").click(function (e) {
  vunmute();
})

$("#venable").click(function (e) {
  venable();
})

$("#vdisable").click(function (e) {
  vunenable();
})
...
async function vunmute() {
   localTracks.videoTrack.setMuted(false);
}

async function venable() {
  localTracks.videoTrack.setEnabled(true);
}

async function vunenable() {
